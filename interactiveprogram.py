...
pyttsx3.speak("what you want to run sir?")
...
while var==1 :
 ...
 elif((("thanks"in p) or ("thank you" in p)) and (("end" in p) or ("exit" in p) or ("terminate" in p) or ("turn off" in p))) :
    print("your welcome sir, It was a pleasure to help you sir ..")
    pyttsx3.speak("your welcome sir, ...It was a pleasure to help you sir ..Have a nice day ")
    exit()
